...
\textbf{ID:} UC401\\
\textbf{Description :} Le diététicien souhaite pouvoir élaborer un plat (petit-déjeuner, déjeuner, souper) en renseignant sa composition.\\
...
\begin{enumerate}
	\item Le système affiche la liste des plats déjà crée.
	\item Le diététicien choisi de créer un nouveau plat.
...
Les deux scénario alternatifs débute après l'étape 1 du scénario nominal.
\begin{enumerate}
	...
	\end{enumerate}
\end{enumerate}
Dans les deux cas, le cas d'utilisation reprend à l'étape 2 du scénario nominal.

\noindent \textbf{Post-Conditions:} Le plat est crée, modifié ou supprimé.

\begin{figure}
\centering
\includegraphics[scale=0.3]{../../CasDUtilisations/CompositionPlat/sequence_composer_plat.png}
